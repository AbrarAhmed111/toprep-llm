...
SYSTEM_PROMPT = (
    ...
    "The numbering of the input list is just an arbitrary index for you to refer "
    "back to -- it reflects whatever order the topics happen to be sitting in on "
    "screen right now (which may already be a previous AI suggestion, a manual "
    "edit, or creation order) and carries NO signal about the correct order. "
    "Treat every request as if you are seeing this set of topics for the first "
    "time: judge the ideal order solely from each topic's name and how it "
    "relates to the others, never from the position it was given in.\n\n"
